...
const defaultHeartImages = Array.from({ length: 66 }, (_, i) => `images/img${i + 1}.jpg`);
...
const ringTexts = [
  'Galaxy of love From Hael',//untuk deskripsi planet layer 1
  "I love you",//untuk deskripsi planet layer 2
  "♡Happy Birthday Sayang♡",//untuk deskripsi planet layer 3
  "17/10/2003",//untuk deskripsi planet layer 4
...
function preloadGalaxyAudio() {
  const audioSources = [
"https://youtu.be/d4OMqGKBl6E?si=eRU-UvAjlmXPm4_B"
  ];
